...
public class GameplayScreen extends AbstractScreen {
	public static final float SPRITE_SCALE = Properties.getFloat("sprite.scale", .02f);
	...
	public GameplayScreen(GDXGame game, Skin skin, GDXLevel level, final GDXRenderer gdxRenderer, 
			FileHandle selectedFile, GDXWorld gdxWorld, FileHandle carFileHandle, MainWindow mainWindow, 
